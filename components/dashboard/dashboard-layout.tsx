...
import { GitBranch, Leaf, Settings, ShieldCheck, Users, Menu, Bell } from "lucide-react";
      ...
      <div className="relative mx-auto max-w-7xl px-4 pb-16 pt-6 sm:px-6 lg:px-8">
        ...
        <header className="mb-10 flex flex-wrap items-center justify-between gap-6 border-b border-white/[0.05] pb-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <button className="md:hidden flex h-9 w-9 items-center justify-center rounded-full border border-white/[0.08] bg-white/[0.02] text-floral/40">
              <Menu size={18} />
            </button>
          </div>
        </header>
